...
#生成dex 
cd $buildToolPath 
# ./dx --dex --output=$workPath/dex/classes.dex  $workPath/dex/myJar.jar $jarName1 $jarName2 $jarName3 $jarName4 $jarName5 $jarName6 $jarName7 $jarName8 $jarName9 $jarName10 $jarName11 $jarName12 $jarName13 $jarName14 $jarName15 $jarName16 $jarName26 $jarName28 $jarName27 $jarName24 $jarName25

# ./dx --dex --output=$workPath/dex/classes.dex  $workPath/dex/myJar.jar $jarName1 $jarName2 $jarName3 $jarName4 $jarName5 $jarName6 $jarName7 $jarName8 $jarName9 $jarName10 $jarName11 $jarName12 $jarName13 $jarName14 $jarName15 $jarName16 $jarName17 $jarName18 $jarName19 $jarName20 $jarName21 $jarName22 $jarName23 $jarName26 $jarName28 $jarName27 $jarName24 $jarName25

# mv -f $workPath/dex/classes.dex $workPath/resources 

#合并成apk
cd $workPath/resources
zip -r my.apk ./*

mv -f $workPath/resources/my.apk $workPath

cd $buildToolPath
./apksigner sign  --ks $workPath/keystore/deshi.jks  --ks-key-alias deshi  --ks-pass pass:deshi123456  --key-pass pass:deshi123456  --out $workPath/output.apk  $workPath/my.apk
...
adb uninstall 'com.pluggable.raqusty.pluggable'
adb  install -r -t $workPath/finish.apk
adb  shell am start -n 'com.pluggable.raqusty.pluggable/com.pluggable.raqusty.pluggable.MainActivity'
