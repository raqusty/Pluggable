...
# 生成R文件
./aapt  package --auto-add-overlay -f -m -S $projectPath/res/ -S $resName5 -S $resName11 -I $platformsPath/android.jar -M $projectPath/AndroidManifest.xml -J $workPath/ 

# 生成资源文件
./aapt  package --auto-add-overlay -f -m -S $projectPath/res/ -S $resName5 -S $resName11 -I $platformsPath/android.jar -M $projectPath/AndroidManifest.xml -F $workPath/resources/myApk.zip
